...
public class AccountService {
	...
	public AccountRequestBackend getAccountRequestBackend(Exchange exchange) throws Exception {
		...
		AccountRequest oAccountRequest = exchange.getIn().getBody(AccountRequest.class); // getting the account request
																							// through exchange
		...
		oAccountDetailsBackendRequest.setAccno(oAccountDetailsRequest.getAccno()); // setting the request accno and
																					// passing to backend
	...
	public void getAccountDetailsBackendResponse(Exchange exchange) throws Exception {
		...
		oAccountDetailsBackendResponse = oAccountResponseBackend.getAccountDetailsBackendResponse(); // getting the
																										// response to
																										// requested
																										// request
		...
		for (BankMembersBackend bankMembersBackend : bankMembersBackends) { // Syntax for(type variableName : arrayname)
																			// {} used to iterate through list or array
